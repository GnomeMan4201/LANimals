...
class LocalInterfaceMacTests(unittest.TestCase):
    def test_get_iface_mac_reads_and_normalizes_sysfs_address(self) -> None:
    ...
    def test_get_iface_mac_missing_or_unreadable_is_best_effort_none(self) -> None:
        with patch.object(collectors, "Path") as path_cls:
